...
export type RootQuery = {
  ...
  /** Fields of the &#039;UbSettingsSettings&#039; settings group */
  ubSettingsSettings?: Maybe<UbSettingsSettings>;
  /** Returns a user */
  user?: Maybe<User>;
  /** Returns a user role */
...
export type Settings = {
  ...
  /** Settings of the the string Settings Group */
  ubSettingsSettingsUbIconChoices?: Maybe<Scalars['String']['output']>;
  /** Settings of the the integer Settings Group */
...
/** The ubSettings setting type */
export type UbSettingsSettings = {
  __typename?: 'UbSettingsSettings';
  /** The string Settings Group */
  ubIconChoices?: Maybe<Scalars['String']['output']>;
};
...
export type UpdateSettingsInput = {
  ...
  ubSettingsSettingsUbIconChoices?: InputMaybe<Scalars['String']['input']>;
  /** 預設文章分類。 */
...
export type UpdateSettingsPayload = {
  ...
  readingSettings?: Maybe<ReadingSettings>;
  /** Update the UbSettingsSettings setting. */
  ubSettingsSettings?: Maybe<UbSettingsSettings>;
...
export type CategoryQuery = { __typename?: 'RootQuery', category?: { __typename?: 'Category', name?: string | null, description?: string | null, slug?: string | null } | null };
...
export type PageQuery = { __typename?: 'RootQuery', page?: { __typename?: 'Page', title?: string | null, content?: string | null } | null };
...
export type PostsQueryVariables = Exact<{
  ...
  categoryName?: InputMaybe<Scalars['String']['input']>;
  authorName?: InputMaybe<Scalars['String']['input']>;
  includeExcerpt?: InputMaybe<Scalars['Boolean']['input']>;
...
export type PopularTagsQuery = { __typename?: 'RootQuery', tags?: { __typename?: 'RootQueryToTagConnection', nodes: Array<{ __typename?: 'Tag', id: string, slug?: string | null, name?: string | null }> } | null };

export type UserQueryVariables = Exact<{
  authorName: Scalars['ID']['input'];
}>;


export type UserQuery = { __typename?: 'RootQuery', user?: { __typename?: 'User', nickname?: string | null, name?: string | null, slug?: string | null, description?: string | null, facebook?: string | null, instagram?: string | null, avatar?: { __typename?: 'Avatar', url?: string | null } | null } | null };

export type UsersQueryVariables = Exact<{ [key: string]: never; }>;


export type UsersQuery = { __typename?: 'RootQuery', users?: { __typename?: 'RootQueryToUserConnection', nodes: Array<{ __typename?: 'User', id: string, nickname?: string | null, name?: string | null, slug?: string | null, description?: string | null, facebook?: string | null, instagram?: string | null, avatar?: { __typename?: 'Avatar', url?: string | null } | null }> } | null };


export const CategoryDocument = gql`
    query Category($categoryName: ID!) {
...
export const PostsDocument = gql`
    query Posts($first: Int, $categoryName: String, $authorName: String, $includeExcerpt: Boolean = false, $includePageInfo: Boolean = false, $in: [ID], $notIn: [ID], $tagSlug: [String], $searchKeyword: String, $after: String, $includeDetails: Boolean = false, $orderBy: PostObjectsConnectionOrderbyEnum = DATE) {
  posts(
    where: {orderby: {field: $orderBy, order: DESC}, categoryName: $categoryName, authorName: $authorName, in: $in, notIn: $notIn, tagSlugIn: $tagSlug, search: $searchKeyword}
    first: $first
    after: $after
  ) {
    nodes {
 ...
 *      includeExcerpt: // value for 'includeExcerpt'
...
export const PopularTagsDocument = gql`
    query PopularTags($first: Int = 15) {
  tags(where: {order: DESC, orderby: COUNT}, first: $first) {
    nodes {
      id
      slug
      name
...
export function usePopularTagsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<PopularTagsQuery, PopularTagsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
...
export const UserDocument = gql`
    query User($authorName: ID!) {
  user(id: $authorName, idType: SLUG) {
    nickname
    name
    slug
    description
